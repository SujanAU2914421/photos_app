		...
		<>
			<div className="relative h-full w-full overflow-y-auto">
				<div className="relative h-auto w-full px-0 py-0">
					<div className="relative h-auto w-full px-4 py-0">
						<div className="relative h-auto w-full flex items-center gap-64 py-8 overflow-hidden justify-between xl:px-32 lg:px-32 md:px-16 px-4">
							<div className="relative h-auto w-auto">
								...
								<div className="relative h-auto w-auto">
									<div className="relative h-auto text-sm font-normal text-gray-500 w-full mt-8">
										Visit and uplooad with in worlds most
										strongest security system. No worry no
										problems just click and upload.
									</div>
									<div className="relative h-auto text-sm font-medium text-gray-500 w-full mt-8">
										Upload your favorite images and follow
										people. Enjoy every movement and capture
										them.
									</div>
									<div className="relative mt-16 h-auto w-auto flex items-center gap-6">
										...
										<div className="relative h-auto w-auto text-xs font-light text-gray-600">
											The link redirects you to your
											profile
										</div>
									</div>
								</div>
							</div>
							<div className="relative h-[300px] w-[300px] xl:flex lg:flex hidden items-center justify-center">
					...
					<div className="relative h-auto w-full pb-16">
						<div className="relative h-auto w-full mt-8 xl:px-32 lg:px-32 md:px-16 px-4">
							<div className="relative h-auto xl:w-5/12 lg:w-5/12 md:w-7/12 w-full">
								<div className="relative h-auto w-full">
									<div className="text-3xl font-light text-gray-700">
										Recntly posted
									</div>
									<div className="relative h-auto w-full text-sm font-light mt-6">
										There are many popular images that you
										should checkout
									</div>
											...
											<div className="relative h-[90%] w-[300px] bg-gray-100 flex items-center justify-center rounded-md overflow-hidden group">
												<div className="relative h-full w-full flex items-center justify-center">
													<div
														...
														style={{
															background:
																"url(https://images.unsplash.com/photo-1640622842924-3ae860f77265?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=872&q=80)",
															backgroundPosition:
																"center",
															backgroundSize:
																"cover",
											...
											<div className="relative h-[90%] w-[300px] bg-gray-100 flex items-center justify-center rounded-md overflow-hidden group">
												<div className="relative h-full w-full flex items-center justify-center">
													<div
														...
														style={{
															background:
																"url(https://images.unsplash.com/photo-1643622744071-6aa7644a0ffd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=465&q=80)",
															backgroundPosition:
																"center",
															backgroundSize:
																"cover",
											...
											<div className="relative h-[90%] w-[300px] bg-gray-100 flex items-center justify-center rounded-md overflow-hidden group">
												<div className="relative h-full w-full flex items-center justify-center">
													<div
														...
														style={{
															background:
																"url(https://images.unsplash.com/photo-1643673917448-112343014172?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80)",
															backgroundPosition:
																"center",
															backgroundSize:
																"cover",
						...
						<div className="relative h-auto w-full mt-16 xl:px-32 lg:px-32 md:px-16 px-4">
							<div className="relative h-auto xl:w-5/12 lg:w-5/12 md:w-7/12 w-full">
								<div className="relative h-auto w-full">
									<div className="text-3xl font-light text-gray-700">
										Recntly posted
									...
									<div className="relative h-auto w-full text-sm font-light mt-6">
										The popular peoples recent post. There
										are thoussands of recently added photos.
										The posting rate is icreasing day by
											...
											<div className="relative h-[90%] w-[300px] bg-gray-100 flex items-center justify-center rounded-md overflow-hidden group">
												<div className="relative h-full w-full flex items-center justify-center">
													<div
														...
														style={{
															background:
																"url(https://images.unsplash.com/photo-1640622660606-001c39ac2319?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80)",
															backgroundPosition:
																"center",
															backgroundSize:
																"cover",
											...
											<div className="relative h-[90%] w-[300px] bg-gray-100 flex items-center justify-center rounded-md overflow-hidden group">
												<div className="relative h-full w-full flex items-center justify-center">
													<div
														...
														style={{
															background:
																"url(https://images.unsplash.com/photo-1643721859448-4d241d04448b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80)",
															backgroundPosition:
																"center",
															backgroundSize:
																"cover",
											...
											<div className="relative h-[90%] w-[300px] bg-gray-100 flex items-center justify-center rounded-md overflow-hidden group">
												<div className="relative h-full w-full flex items-center justify-center">
													<div
														...
														style={{
															background:
																"url(https://images.unsplash.com/photo-1638913658828-afb88c3d4d11?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80)",
															backgroundPosition:
																"center",
															backgroundSize:
																"cover",
						...
						<div className="relative h-auto w-full mt-28 xl:px-32 lg:px-32 md:px-16 px-4 hidden">
							<div className="relative h-auto w-auto text-sm font-light flex items-center gap-2 capitalize bottom-4">
								Most recent posts -
								<Link
									to="/recent"
									className="relative text-xs text-gray-600"
								>
									see all
								</Link>
							</div>
